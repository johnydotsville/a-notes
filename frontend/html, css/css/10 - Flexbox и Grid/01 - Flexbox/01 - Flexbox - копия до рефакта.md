...
Элементы не переносятся и всеми силами стараются сжаться и уместиться в доступную ширину. Даже если им явно заданы размеры, все равно они сожмутся. Например, если задать элементам ширину 1500, все равно они сожмутся и влезут в одну строку.
