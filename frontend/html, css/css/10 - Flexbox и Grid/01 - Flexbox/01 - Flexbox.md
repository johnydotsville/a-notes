...
### С обратным переносом, wap-reverse
...
## Направление оси + перенос элементов, flex-flow
...
## Выравнивание строк \ столбцов внутри контейнера, align-content
...
* Растягивание обычно у всех элементов оставляют в 0, а одному элементу ставят в 1, если нужно растянуть его на все доступное место.
