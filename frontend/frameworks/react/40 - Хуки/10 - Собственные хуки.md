...
В целом, кастомный хук - это обычная функция, с одним отличием - она обязана иметь префикс `use`, иначе реакт просто не позволит использовать внутри нее хук. Вероятно, таким образом реакт защищается от того, чтобы мы не смогли использовать хуки в неположенных местах, вроде JSX.
